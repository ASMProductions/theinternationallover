...
export default function InternationalLover() {
  ...
  useEffect(() => {
    if (view === "course") {
    return <CourseView onBack={() => setView("library")} />;
  }
      ...
      <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia, serif" }}>
        ...
        <div style={{ maxWidth:"900px", margin:"0 auto", padding:"2rem 1.5rem" }}>
          <div style={{ display:"flex", gap:12, marginBottom:"1.75rem", flexWrap:"wrap" }}>
            <div style={{ flex:1, minWidth:200, background:C.navyDeep, border:`1px solid ${C.gold}`, padding:"1rem 1.25rem", cursor:"pointer" }} onClick={() => setView("course")}>
