...
const ENDING_LABELS = {
  ...
  fraud_detected:"II — Fraud Detected & Avoided",
  time_waster:"III — Time Waster Identified",
  walkaway:"IV — Correct Walkaway",
  father_no:"V — Father Says No",
  she_no:"VI — She Says No",
  cultural_mismatch:"VII — Cultural Mismatch",
  early_detect:"II — Failed Vetting — Pre-Travel",
  cultural_fail:"VII — Cultural Misnavigation",
  fraud_pre:"II — Fraudulent Approach — Pre-Travel",
  fraud_post:"II — Fraud — Post-Citizenship",
  genuine_wrong:"VI — Incompatible Despite Genuine Connection",
};
