...
const COURSE_OPENING = [
  ...
  "What you are about to encounter is not a game. It is a mirror. Every decision you make inside these scenarios reflects a decision you are capable of making in real life.",
  "Some of these women are genuine. Some are not. Some are genuine and still wrong for you. You will not be told which is which.",
...
const ENDING_COLORS = {
  ...
  fraud_pre:"#8b1a1a", fraud_post:"#6b0f0f",
};
...
const REGIONS_COURSE = [
  {
    ...
    women:[
      {
        ...
        profileText:"I am a teacher. I love books and the Arabic language. I come from a family that holds education and faith as its highest values. I am looking for a husband who is serious about building a home. My father will speak for me when the time is right.",
        hidden:"Her father is a retired Arabic calligrapher. Her mother passed away three years ago. She is the eldest of four siblings and has managed the household since. She has not responded to the last eleven messages she received.",
        ...
        type:"genuine" },
      {
        ...
        profileText:"I am a young woman who loves life, travel, and learning new things. American men seem to understand women better than men here. I want a partner who will be my equal and treat me with respect.",
    ...
    scenario:{
      title:"First Contact",
      setup:"You have reviewed all three profiles. Yasmine has already sent you a message. It arrived twelve minutes after you created your account. Nadia shows 847 views and zero responses. Fatima-Zahra requires you to contact her father.",
      choices:[
        {id:"a", text:"Respond to Yasmine — she reached out first and her English is excellent", consequence:"She responds in four minutes. On day five she mentions her phone needs repair but does not ask for anything directly."},
        {id:"b", text:"Send a careful first message to Nadia in French, referencing her teaching work", consequence:"No reply for eleven days. On the twelfth, three sentences in formal French. She thanks you."},
        {id:"c", text:"Request Fatima-Zahra's father's contact information and compose a formal letter", consequence:"His reply arrives in seven days — in classical Arabic. You need a translator."},
      ]
    },
    endings:{
      success:"You read the culture correctly. You vetted thoroughly. The mahr is agreed. The nikah is performed in her family's city. When she arrives, you are married within 48 hours.",
      early_detect:"You caught the fraud before boarding the flight. The cost was the cheapest it will ever be.",
      cultural_fail:"She was real. Her father was real. What ended it was the accumulation of small cultural failures. Three months later her father called to say they were closing the process.",
      fraud_pre:"You married her. You missed the signals. But you caught it before citizenship. The second phone. The messages in Arabic.",
  ...
  },
  {
    ...
    women:[
      {
        ...
        profileText:"I am a nurse and I believe in service. I am looking for a man who understands that a good wife is built from character, not from beauty. I am ready for marriage. I am not ready for games.",
        hidden:"She has had serious correspondence with two men before. The American ended contact without explanation. The British man proposed then withdrew. She is careful now in a way she was not before.",
        ...
        type:"genuine" },
      {
        ...
        hidden:"Her father is a former journalist forced to leave Lebanon in 2019. The family has been in financial difficulty since. Her mother has told her more than once that an American husband would solve several problems.",
        ...
        type:"genuine_wrong" },
      {
        ...
        hidden:"Maryam has a published book of Arabic poetry used in secondary schools. Her brother has turned away six inquiries without telling her. He still manages the account but now must tell her before dismissing anyone.",
        signal:"This account has been active eleven months with one recorded inquiry sent — to someone else. She reached out once. That person did not respond.",
        type:"genuine" },
    ],
    scenario:{
      title:"First Contact",
      ...
      choices:[
        {id:"a", text:"Message Sara directly — her English is clear and her profile is honest", consequence:"She replies in three days. She asks: What does a good husband look like to you?"},
        {id:"b", text:"Message Hessa — she is the most immediately accessible culturally", consequence:"She responds within an hour. On day eight she mentions her father is going through financial difficulty."},
    ...
    endings:{
      ...
      early_detect:"When you asked what she loved about her life exactly as it was, she went quiet for a long time. Her answer told you everything. You ended it kindly.",
      cultural_fail:"You misrepresented your religious practice to gain access to the family. The marriage began on a lie. When the truth surfaced, the damage was to both of you.",
      fraud_pre:"The financial pressure was always present. You caught the pattern before citizenship. The damage was limited.",
      fraud_post:"She had a brother she wanted to bring over. The marriage was the instrument. Post-citizenship, the plan executed exactly as it had been designed.",
    }
  },
  {
    id:"as", label:"Asia", desc:"Indonesia, Philippines, Bangladesh",
    context:"The common threads across Asia: family embeddedness, high-context communication, and the reality that the economic gap between an American man and her family can distort the power dynamic significantly.",
    women:[
      {
        id:"amira", name:"Amira", age:25, city:"Yogyakarta, Indonesia", religion:"Muslim (traditionalist)", platform:"Muslima.com",
        profileText:"My family is my world. My faith is my foundation. I am not looking for a man to take me somewhere. I am looking for a man to build something with me — here or wherever Allah wills.",
        hidden:"Her father is an imam of a small mosque. She has no strong desire to go to America. She is genuinely indifferent to geography. This will confuse men who assume she wants an exit.",
        signal:"Most men approach women from this region assuming they want to leave. Her profile does not say this. Most men miss that.",
        type:"genuine" },
      {
        id:"jasmine", name:"Jasmine", age:24, city:"Cebu, Philippines", religion:"Catholic", platform:"ChristianMingle",
        profileText:"Family is everything to me. I take care of my parents and my two younger brothers. I want a husband who understands that when you marry me, you marry my whole family.",
        hidden:"Her father has a heart condition. She sends forty percent of her salary home monthly. She has a two-year-old son from a relationship that ended. She has not included this in her profile.",
        ...
        type:"genuine_wrong" },
      {
        ...
        profileText:"I believe marriage is a partnership. I am not looking to be managed. I am looking for a man who is secure enough to be beside me rather than above me.",
    ...
    scenario:{
      title:"First Contact",
      setup:"Amira's father must be contacted first. Jasmine's profile is warm and family-centered. Nurul's profile is direct and intelligent. Three very different entry points. Three very different tests.",
      choices:[
        ...
        {id:"b", text:"Message Jasmine — her profile is warm and her English is strong", consequence:"She responds with warmth and specificity. She asks about your family immediately."},
    ...
    endings:{
      success:"You understood that her family's financial need was real and not shameful. You discussed remittances before the marriage, not after. The marriage was built on that foundation.",
      early_detect:"You held the line — no money before the vetting was complete. She respected it. Or she revealed herself. Either way, you were protected.",
      cultural_fail:"She was not passive. She was polite. Those are not the same thing.",
      fraud_pre:"The requests escalated once she arrived. You caught it before citizenship — the separate account, the money transfers you did not authorize.",
  ...
  },
  {
    ...
    context:"Latin America is the arc with the most cultural overlap with American experience and therefore the most dangerous false sense of familiarity. The man who thinks he understands it has not begun to understand it.",
    women:[
      {
        ...
        hidden:"She was engaged three years ago to a local man who left her two months before the wedding. She has ended three previous platform conversations because she felt something was being performed rather than lived.",
        ...
        type:"genuine" },
      {
        ...
        profileText:"I want a better life. I am not ashamed to say this. My country is difficult. I work hard and I want a man who works hard with me. I want a husband who will be faithful.",
        hidden:"Diana does want a better life — that is genuine. She has a two-year-old son from a relationship that ended. She has not included this. She intends to disclose it once a connection is established.",
        signal:"How she handles the disclosure will tell you more about her than anything else.",
        type:"genuine_wrong" },
      {
        id:"elena", name:"Elena", age:30, city:"Lima, Peru", religion:"Catholic with indigenous traditions", platform:"SimplyMarry.com",
        profileText:"I have spent years going into communities the city forgets. I have seen what a family without a father becomes. I am looking for a serious man — not a perfect man, but a man committed to being better.",
        hidden:"She has been proposed to twice and declined both. She declined because he said he would want her to stop working after they had children. She told him she could not agree.",
        signal:"She is accomplished and has already filtered out men who could not accept her whole life.",
        type:"genuine" },
    ],
    scenario:{
      title:"First Contact",
      ...
      choices:[
        ...
        {id:"b", text:"Message Diana — her honesty about wanting a better life is refreshing", consequence:"She responds warmly. On week three she mentions her son."},
        {id:"c", text:"Message Elena — her profile is the most substantive", consequence:"She responds in 48 hours. She asks whether you have any experience with community work."},
      ]
    },
    endings:{
      success:"Valentina tested you three times before she showed warmth. You passed each time — not by performing but by being consistent.",
      early_detect:"Diana's son was disclosed on week three. You were not sure you were ready to be a step-father and you said so directly. You ended it with dignity on both sides.",
      cultural_fail:"The father's dinner table was an evaluation you did not know you were sitting at. She became who she always was, once the performance of early love had passed.",
      fraud_pre:"What she was in Medellin and what she was becoming in America were visibly different. You caught it before it became irreversible.",
      fraud_post:"The erosion was quiet and cumulative. She was a woman placed in an environment that constantly offered her an alternative identity.",
    }
  },
  {
    ...
    women:[
      {
        ...
        profileText:"I come from a family of teachers and scholars. My grandfather was a marabout. My father is a teacher. I am a teacher. I am looking for a man who understands that a wife brings her lineage, her faith, and her gifts.",
        hidden:"The Tijaniyya order has its own practices, rhythms, and community obligations. A man who dismisses Sufi Islam as unorthodox will be filtered out by her family long before he understands what happened.",
        ...
        type:"genuine" },
      {
        ...
        profileText:"I believe God has a plan for every life. I am not desperate — I am deliberate. My parents are involved in everything important that I do. This is not a warning. It is a promise.",
        hidden:"Her uncle is a well-known Pentecostal pastor in Accra. Her family will expect you to attend a service during any visit — not as a cultural experience, as a statement of who you are.",
        ...
        type:"genuine_wrong" },
      {
        ...
        profileText:"I am on this platform because my family asked me to consider men from outside Ethiopia. I am not certain this is the right path for me. But I am willing to be shown that it is.",
        hidden:"Ethiopian Orthodox Christianity has over 250 fasting days and its own deeply embedded community practices. Her family created this profile hoping she will meet an Ethiopian man from the diaspora.",
    ...
    scenario:{
      title:"First Contact",
      setup:"Fatou's profile speaks of lineage and knowledge. Abena promises family involvement — directly. Tigist admits uncertainty. Each opening position is a test of how you read what is in front of you.",
      choices:[
    ...
    endings:{
      success:"You entered a lineage, a community, and a tradition that predates your own country. The bride price negotiation was conducted with respect. The children of this marriage will be connected to a history the American education system largely erased.",
      early_detect:"You recognized the romance scam pattern early. You walked away before it cost you more than your time.",
      cultural_fail:"Your intentions were good. Your preparation was not. The arc ended in a series of cooling conversations and a father who stopped returning calls.",
      fraud_pre:"The money was moving in directions you had not agreed to. You caught it before citizenship with the help of an attorney.",
      fraud_post:"The citizenship was the goal. The marriage was the instrument. After naturalization, the departure was organized and deliberate. The children remained.",
    }
  },
];
...
function ILShield({ size=48 }) {
  return (
    <svg viewBox="0 0 60 72" width={size} style={{ display:"block", margin:"0 auto" }}>
...
function ProfileCard({ woman, selected, onSelect, revealed }) {
  return (
    <div onClick={onSelect} style={{ cursor:"pointer", border:"2px solid " + (selected ? "#b8963e" : "#1e3a6e"), background:selected ? "rgba(184,150,62,0.08)" : "#0f2347", padding:"1.25rem", transition:"all 0.3s", position:"relative" }}>
...
export default function CoursePage() {
  ...
  if (phase === "intro") return (
    <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia,serif" }}>
      <NavBar left={<button onClick={goBack} style={{ background:"none", border:"1px solid #b8963e", color:"#b8963e", padding:"6px 14px", borderRadius:"20px", cursor:"pointer", fontSize:"13px", fontFamily:"sans-serif" }}>Back</button>} title="Course Opening" />
  ...
  if (phase === "map") return (
    <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia,serif" }}>
      <NavBar
        left={<button onClick={goBack} style={{ background:"none", border:"1px solid #b8963e", color:"#b8963e", padding:"6px 14px", borderRadius:"20px", cursor:"pointer", fontSize:"13px", fontFamily:"sans-serif" }}>Back</button>}
        ...
        <div style={{ background:C.navyDeep, border:"1px solid #1e3a6e", padding:"1.25rem", marginBottom:"2rem", textAlign:"center" }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", gap:12, flexWrap:"wrap", marginBottom:12 }}>
            {REGIONS_COURSE.map(r => (
              <div key={r.id} style={{ display:"inline-flex", alignItems:"center", justifyContent:"center", width:64, height:64, borderRadius:"50%", border:"1.5px " + (stampedRegions.includes(r.id) ? "solid" : "dashed") + " #b8963e", background:stampedRegions.includes(r.id) ? "rgba(184,150,62,0.12)" : "transparent", opacity:stampedRegions.includes(r.id) ? 1 : 0.3 }}>
                <div style={{ fontSize:6.5, color:C.gold, fontFamily:"sans-serif", textAlign:"center", lineHeight:1.35 }}>{r.label}</div>
              </div>
            ))}
          </div>
          {stampedRegions.length === 5 && (
            <button onClick={() => setPhase("certificate")} style={{ padding:"10px 24px", background:C.gold, color:C.navyDeep, border:"none", cursor:"pointer", fontSize:12, fontWeight:700, fontFamily:"sans-serif" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(240px,1fr))", gap:16 }}>
          {REGIONS_COURSE.map(r => (
            <div key={r.id} onClick={() => selectRegion(r.id)}
              style={{ background:C.navyDeep, border:"1px solid " + (stampedRegions.includes(r.id) ? C.gold : "#1e3a6e"), padding:"1.5rem", cursor:"pointer", position:"relative" }}>
              ...
              <div style={{ fontSize:11, color:C.creamDim, lineHeight:1.65, fontFamily:"sans-serif", marginBottom:12 }}>{r.context.slice(0,100) + "..."}</div>
              <div style={{ fontSize:10, color:C.gold, fontFamily:"sans-serif" }}>{stampedRegions.includes(r.id) ? "STAMPED — REVISIT" : "ENTER REGION"}</div>
            </div>
          ))}
        </div>
      </div>
    ...
    <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia,serif" }}>
      ...
      <div style={{ maxWidth:860, margin:"0 auto", padding:"2rem 1.5rem" }}>
        ...
        <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
          <button onClick={() => { if (selectedWomanId) { setChoiceHistory([]); setScenarioStep(0); setOutcome(null); setPhase("scenario"); } }} disabled={!selectedWomanId}
            style={{ padding:"12px 28px", background:selectedWomanId ? C.gold : "#1e3a6e", color:selectedWomanId ? C.navyDeep : C.mutedDark, border:"none", cursor:selectedWomanId ? "pointer" : "default", fontSize:12, fontWeight:700, fontFamily:"sans-serif" }}>
            Begin Scenario
          </button>
          <button onClick={revealNext} disabled={revealedCards.length >= 3}
            style={{ padding:"12px 20px", background:"transparent", color:C.muted, border:"1px solid #1e3a6e", cursor:"pointer", fontSize:11, fontFamily:"sans-serif" }}>
      ...
      <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia,serif" }}>
        ...
        <div style={{ maxWidth:640, margin:"0 auto", padding:"3rem 1.5rem" }}>
          <div style={{ textAlign:"center", marginBottom:"2rem" }}>
            ...
            <div style={{ fontSize:"clamp(16px,2.5vw,22px)", color:color, fontFamily:"Georgia,serif", marginBottom:16 }}>{ENDING_LABELS[outcome]}</div>
          ...
          <div style={{ display:"flex", gap:10, flexWrap:"wrap", justifyContent:"center" }}>
            ...
            <button onClick={completeRegion}
              ...
              {stampedRegions.includes(activeRegionId) ? "Return to Map" : "Stamp Passport and Continue"}
            </button>
          </div>
        </div>
      </div>
  ...
  if (phase === "certificate") return (
    <div style={{ minHeight:"100vh", background:C.dark, color:C.cream, fontFamily:"Georgia,serif" }}>
      ...
      <div style={{ maxWidth:600, margin:"0 auto", padding:"3rem 1.5rem", textAlign:"center" }}>
        <div style={{ background:"linear-gradient(160deg,#0f2347,#1a3a6b)", border:"2px solid #b8963e", padding:"3rem 2rem", position:"relative" }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", gap:8, margin:"16px 0", flexWrap:"wrap" }}>
            {REGIONS_COURSE.map(r => (
              <div key={r.id} style={{ display:"inline-flex", alignItems:"center", justifyContent:"center", width:44, height:44, borderRadius:"50%", border:"1.5px solid #b8963e", background:"rgba(184,150,62,0.12)" }}>
                <div style={{ fontSize:5.5, color:C.gold, fontFamily:"sans-serif", textAlign:"center" }}>{r.label.slice(0,4).toUpperCase()}</div>
              </div>
            ))}
          </div>
          ...
          <p style={{ fontSize:11, color:C.creamDim, lineHeight:1.85, maxWidth:420, margin:"0 auto 16px", fontStyle:"italic", fontFamily:"sans-serif" }}>having demonstrated the knowledge, cultural intelligence, and discernment required — is hereby commissioned to venture forth as an International Lover.</p>
          <div style={{ fontSize:12, color:C.muted, fontFamily:"sans-serif" }}>The International Lover</div>
        </div>
        <div style={{ marginTop:20, display:"flex", gap:10, justifyContent:"center", flexWrap:"wrap" }}>
          <button onClick={() => window.print()} style={{ padding:"10px 22px", background:C.gold, color:C.navyDeep, border:"none", cursor:"pointer", fontSize:12, fontWeight:700, fontFamily:"sans-serif" }}>Print Certificate</button>
          <button onClick={goBack} style={{ padding:"10px 22px", background:"transparent", color:C.muted, border:"1px solid #1e3a6e", cursor:"pointer", fontSize:12, fontFamily:"sans-serif" }}>Back</button>
        </div>
      </div>
    </div>
  );
